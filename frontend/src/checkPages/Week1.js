                ...
                <div>
                    {record && (
                        <div>
                            ...
                            {/* {record.task3 ? 'done' : 'notdone'}---{record.task4 ? 'done' : 'notdone'}---{record.task5 ? 'done' : 'notdone'}---{record.task6 ? 'done' : 'notdone'}---{record.link2} */}
                            ---{record.link1}
                            <form onSubmit={handleSubmit}>
                                ...
                                <input type="checkbox" checked={taskfive} onChange={handleCheck5} disabled={true}/>task5
                                <input type="checkbox" checked={tasksix} onChange={handleCheck6} disabled={true}/>task6
            ...
            <div>
                {week && week.map((x) => (
                    <p key={x._id}>
                        ...
                        {/* ---{x.task3 ? 'done' : 'notdone'}---{x.task4 ? 'done' : 'notdone'}---{x.task5 ? 'done' : 'notdone'}---{x.task6 ? 'done' : 'notdone'}---{x.link2} */}
                        ---{x.link1}
